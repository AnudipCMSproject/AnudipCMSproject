<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="creative03.aspx.vb" Inherits="WebApplication4.creative03" %>
           ...
           <tr>
                ...
                <td class="style2">
                    <asp:Image ID="Image1" runat="server" BorderColor="#CCCCCC" BorderStyle="Ridge" 
                        BorderWidth="10px" Height="528px" ImageUrl="~/image/IMG6.jpg" 
                        Width="1012px" /> 
